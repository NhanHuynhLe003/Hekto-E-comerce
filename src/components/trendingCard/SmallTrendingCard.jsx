...
export default function SmallTrendingCard({
  id,
  name,
  img,
  price,
    ...
    <div className={style.smallTrendingCard}>
      <div className={style.imgContainer}>
        <Image
          width={70}
          height={70}
          src={img ? img : woodenChair}
          alt={name ? "picture-" + name : "None"}
        />
      </div>
      <div className={style.right}>
        <p className={style.nameProduct}>{name}</p>
        <div className={style.priceInfo}>
          <div className={style.priceDiscounted}>
            ${discountPrice ? discountPrice.toFixed(2) : "None"}
          </div>
