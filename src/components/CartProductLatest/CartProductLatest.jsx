...
export default function CartProductLatest({
  isSale = false,
  img,
  id,
  name,
  ...
  return (
    <div className={style.cartLatestProduct}>
      {isSale && (
        <Image className={style.saleLabel} src={saleLabel} alt="sale_label" />
      )}
      <div className={style.controllerBtn}>
        <btn className={clsx(style.controlBtn, style.cart)}>
          <FaShoppingCart />
        </btn>
        <btn className={clsx(style.controlBtn, style.likeHeart)}>
          <FaRegHeart />
        </btn>
        <btn className={clsx(style.controlBtn, style.zoom)}>
          <FaSearchPlus />
        </btn>
      </div>
